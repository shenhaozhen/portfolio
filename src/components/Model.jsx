...
const button = <div className="absolute bottom-[10px] w-full flex justify-center items-center" >
<a href="">
...
const Model = () => {
  return (
    <section className="text-white h-screen w-full mx-auto relative">
      <div className="absolute inset-0 top-[80px] max-w-7xl max-auto flex flex-row items-start gap-5" >
